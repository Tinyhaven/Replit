        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center space-y-6">
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="https://www.gofundme.com/f/tinyhavenproject"
                target="_blank"
            ...
            <a href="/contact" className="text-th-primary hover:text-th-primary-dark font-medium underline">
              In-Kind Donations Link
            </a>
          </div>
        </div>
      </section>
